...
namespace advanced_jobmatchingtool_webapp.Controllers.Kandidaat
{
    ...
    public class BehoeftesKandidaatController : Controller
    {
        private readonly IAntwoordKandidaatService _antwoordKandidaatService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<BehoeftesKandidaatController> _logger;

        public BehoeftesKandidaatController(IAntwoordKandidaatService antwoordKandidaatService, UserManager<ApplicationUser> userManager,
            ApplicationDbContext context, ILogger<BehoeftesKandidaatController> logger)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKandidaatService.GetVragenByNaamCategorieAsync("Behoeftes");
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKandidaatViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "BehoeftesKandidaat");
        }
    }
}

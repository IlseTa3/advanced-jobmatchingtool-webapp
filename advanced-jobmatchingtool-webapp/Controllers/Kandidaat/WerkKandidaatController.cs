...
namespace advanced_jobmatchingtool_webapp.Controllers.Kandidaat
{
    ...
    public class WerkKandidaatController : Controller
    {
        private readonly IAntwoordKandidaatService _antwoordKandidaatService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<WerkKandidaatController> _logger;

        public WerkKandidaatController(IAntwoordKandidaatService antwoordKandidaatService, UserManager<ApplicationUser> userManager,
            ApplicationDbContext context, ILogger<WerkKandidaatController> logger)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKandidaatService.GetVragenByNaamCategorieAsync("Werk");
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKandidaatViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "WerkKandidaat");
        }
    }
}

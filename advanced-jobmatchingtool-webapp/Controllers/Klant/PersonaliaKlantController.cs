...
namespace advanced_jobmatchingtool_webapp.Controllers.Klant
{
    ...
    public class PersonaliaKlantController : Controller
    {
        private readonly IAntwoordKlantService _antwoordKlantService;
        private readonly UserManager<ApplicationUser> _userManager;
        private ILogger<PersonaliaKlantController> _logger;
        private readonly ApplicationDbContext _context;

        public PersonaliaKlantController(IAntwoordKlantService antwoordKlantService, UserManager<ApplicationUser> userManager, ILogger<PersonaliaKlantController> logger, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKlantService.GetVragenByNaamCategorieAsync("Personalia");
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKlantViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "PersonaliaKlant");
        }
    }
}

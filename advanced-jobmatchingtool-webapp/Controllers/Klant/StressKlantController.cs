...
namespace advanced_jobmatchingtool_webapp.Controllers.Klant
{
    ...
    public class StressKlantController : Controller
    {
        private readonly IAntwoordKlantService _antwoordKlantService;
        private readonly UserManager<ApplicationUser> _userManager;
        private ILogger<StressKlantController> _logger;
        private readonly ApplicationDbContext _context;

        public StressKlantController(IAntwoordKlantService antwoordKlantService, UserManager<ApplicationUser> userManager, ILogger<StressKlantController> logger, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKlantService.GetVragenByNaamCategorieAsync("Stress");
            var antwoorden = await _context.AntwoordenKlanten
                .Where(a => a.UserId == userId && a.Categorie.StartsWith("Stress"))
                .ToListAsync();
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKlantViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "StressKlant");
        }
    }
}

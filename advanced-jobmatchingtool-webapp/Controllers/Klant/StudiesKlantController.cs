...
namespace advanced_jobmatchingtool_webapp.Controllers.Klant
{
    ...
    public class StudiesKlantController : Controller
    {
        private readonly IAntwoordKlantService _antwoordKlantService;
        private readonly UserManager<ApplicationUser> _userManager;
        private ILogger<StudiesKlantController> _logger;
        private readonly ApplicationDbContext _context;

        public StudiesKlantController(IAntwoordKlantService antwoordKlantService, UserManager<ApplicationUser> userManager, ILogger<StudiesKlantController> logger, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKlantService.GetVragenByNaamCategorieAsync("Studies");
            var antwoorden = await _context.AntwoordenKlanten
                .Where(a => a.UserId == userId && a.Categorie.StartsWith("Studies"))
                .ToListAsync();
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKlantViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "StudiesKlant");
        }
    }
}

...
namespace advanced_jobmatchingtool_webapp.Controllers.Klant
{
    ...
    public class TriggersKlantController : Controller
    {
        private readonly IAntwoordKlantService _antwoordKlantService;
        private readonly UserManager<ApplicationUser> _userManager;
        private ILogger<TriggersKlantController> _logger;
        private readonly ApplicationDbContext _context;

        public TriggersKlantController(IAntwoordKlantService antwoordKlantService, UserManager<ApplicationUser> userManager, ILogger<TriggersKlantController> logger, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKlantService.GetVragenByNaamCategorieAsync("Triggers");
            var antwoorden = await _context.AntwoordenKlanten
                .Where(a => a.UserId == userId && a.Categorie.StartsWith("Triggers"))
                .ToListAsync();
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKlantViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "TriggersKlant");
        }
    }
}

...
namespace advanced_jobmatchingtool_webapp.Controllers.Klant
{
    ...
    public class WerkKlantController : Controller
    {
        private readonly IAntwoordKlantService _antwoordKlantService;
        private readonly UserManager<ApplicationUser> _userManager;
        private ILogger<WerkKlantController> _logger;
        private readonly ApplicationDbContext _context;

        public WerkKlantController(IAntwoordKlantService antwoordKlantService, UserManager<ApplicationUser> userManager, ILogger<WerkKlantController> logger, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKlantService.GetVragenByNaamCategorieAsync("Werk");
            var antwoorden = await _context.AntwoordenKlanten
                .Where(a => a.UserId == userId && a.Categorie.StartsWith("Werk"))
                .ToListAsync();
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKlantViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "WerkKlant");
        }
    }
}

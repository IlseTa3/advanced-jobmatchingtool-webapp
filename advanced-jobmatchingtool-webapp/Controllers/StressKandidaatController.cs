...
namespace advanced_jobmatchingtool_webapp.Controllers
{
    ...
    public class StressKandidaatController : Controller
    {
        private readonly IAntwoordKandidaatService _antwoordKandidaatService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<StressKandidaatController> _logger;

        public StressKandidaatController(IAntwoordKandidaatService antwoordKandidaatService, UserManager<ApplicationUser> userManager,
            ApplicationDbContext context, ILogger<StressKandidaatController> logger)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKandidaatService.GetVragenByNaamCategorieAsync("Stress");
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKandidaatViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "StressKandidaat");
        }
    }
}

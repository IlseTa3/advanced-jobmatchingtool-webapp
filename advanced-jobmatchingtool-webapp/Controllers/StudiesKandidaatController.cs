...
namespace advanced_jobmatchingtool_webapp.Controllers
{
    ...
    public class StudiesKandidaatController : Controller
    {
        private readonly IAntwoordKandidaatService _antwoordKandidaatService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<StudiesKandidaatController> _logger;

        public StudiesKandidaatController(IAntwoordKandidaatService antwoordKandidaatService, UserManager<ApplicationUser> userManager,
            ApplicationDbContext context, ILogger<StudiesKandidaatController> logger)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKandidaatService.GetVragenByNaamCategorieAsync("Studies");
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKandidaatViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "StudiesKandidaat");
        }
    }
}

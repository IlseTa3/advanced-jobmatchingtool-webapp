...
namespace advanced_jobmatchingtool_webapp.Controllers
{
    public class SubCategoriesController : Controller
    {
        ...
        public SubCategoriesController(ISubCategorieService subCategorieService)
        {
        ...
        {
            ViewData["CategorieId"] = new SelectList(await _subCategorieService.GetAllCategoriesAsync(), "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NaamSubCategorie,CategorieId")] SubCategorie subCategorie)
        {
            ...
            ViewData["CategorieId"] = new SelectList(await _subCategorieService.GetAllCategoriesAsync(), "Id", "Id", subCategorie.CategorieId);
            return View(subCategorie);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NaamSubCategorie,CategorieId")] SubCategorie subCategorie)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!_subCategorieService.SubCategorieExists(subCategorie.Id))
                    {
                        return NotFound();
                    }
                    else

...
using advanced_jobmatchingtool_webapp.ViewModels.Triggers;
...
namespace advanced_jobmatchingtool_webapp.Controllers
{
    ...
    public class TriggersController : Controller
    {
        ...
        public TriggersController(MongoDbVragenPerCategorieService vragenPerCategorieService, UserManager<ApplicationUser> userManager, ApplicationDbContext context, ILogger<TriggersController> logger)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _vragenPerCategorieService.GetVragenByCategorieAsync("Triggers");

            var antwoorden = await _context.PersonaliaKandidaten
                .Where(a => a.UserId == userId && a.Categorie == "Triggers")
                .ToListAsync();
            ...
            var model = new TriggersViewModel
            {
                ...
                VragenAntwoorden = vragen.Select(v => new VraagAntwoordTriggersViewModel
                {
                    VraagId = v.Id,
        ...
        [HttpPost]
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordTriggersViewModel> vragenAntwoorden)
        {
            var userId = _userManager.GetUserId(User);
            ...
            foreach (var item in vragenAntwoorden)
            {
                ...
                // Opslaan in MySQL
                var bestaandAntwoord = await _context.TriggersKandidaten
                ...
                else
                {
                    ...
                    var nieuwAntwoord = new TriggersKandidaat
                    {
                        UserId = userId,
                    ...
                    _context.TriggersKandidaten.Add(nieuwAntwoord);

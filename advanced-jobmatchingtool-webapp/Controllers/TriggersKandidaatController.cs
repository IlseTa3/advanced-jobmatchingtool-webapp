...
namespace advanced_jobmatchingtool_webapp.Controllers
{
    ...
    public class TriggersKandidaatController : Controller
    {

        private readonly IAntwoordKandidaatService _antwoordKandidaatService;
        private readonly UserManager<ApplicationUser> _userManager;
        private readonly ApplicationDbContext _context;
        private readonly ILogger<TriggersKandidaatController> _logger;

        public TriggersKandidaatController(IAntwoordKandidaatService antwoordKandidaatService, UserManager<ApplicationUser> userManager,
            ApplicationDbContext context, ILogger<TriggersKandidaatController> logger)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var vragen = await _antwoordKandidaatService.GetVragenByNaamCategorieAsync("Triggers");
        ...
        public async Task<IActionResult> SaveAntwoorden(List<VraagAntwoordKandidaatViewModel> vragenAntwoorden)
        {
            ...
            return RedirectToAction("Index", "TriggersKandidaat");
        }
    }
}
